                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                            <h3 class="card-title">
                                Post List <span class="badge bg-info">{{$posts->count()}}</span>
                            </h3>
                                            ...
                                            <div class="dropdown-menu">
                                              ...
                                              {event.preventDefault();
                                                ...
                                                <i class="fas fa-trash text-red"></i> <span class="text-bold font-italic text-danger">DELETE</span> </a>
                                                    ...
                                                    <a class="dropdown-item" onclick="if(confirm('Are you sure? you want to approve this post?')){
                                                        event.preventDefault();
                                                        document.getElementById('approve-{{$post->id}}').submit();
                                                    }"><i class="fas fa-check text-green"></i> <span class="text-bold font-italic text-success">APPROVE</span> 
                                                </a>
