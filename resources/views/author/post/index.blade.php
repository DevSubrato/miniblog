                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between">
                          <h5> Create Post <a href="{{route('author.post.create')}}"><button class="btn btn-primary mr-2"><i class="fa-solid fa-plus"></i></button></a></h5>
                        </div>
                    </div>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                              <a class="dropdown-item" href="{{route ('author.post.show',$post->id) }}"> <i class="fas fa-eye"></i></a>
                                              <a class="dropdown-item" href="{{route ('author.post.edit',$post->id) }}"><i class="fas fa-edit"></i></a>
                                    ...
                                    {{-- <td class="d-flex">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-danger mr-1"><i class="fas fa-trash"
                                                onclick="if(confirm('are you sure?to delete this post')){
                                                 event.preventDefault();
                                                getElementById('delete-form-{{$post->id}}').
                                                submit();}"></i></button>
